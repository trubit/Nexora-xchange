...
- Name: home.spec.js >> Homepage >> footer or bottom bar is present
- Location: e2e\home.spec.js:61:3
...
Locator: locator('footer, [class*=\'bottom-bar\'], [class*=\'footer\']').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('footer, [class*=\'bottom-bar\'], [class*=\'footer\']').first()
